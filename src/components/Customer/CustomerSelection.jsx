    ...
    render() {
        return (
            <div>
                ...
                <div>
                    {this.state.customerType === 'person' && <Person action='new' />}
                    {this.state.customerType === 'company' && <Company action='new' />}
                </div>
            </div>
...
export default withRouter(connect(mapStateToProps)(CustomerSelection))
